...
model_year = [2003, 2004, 2005, 2006]
# Prefix BaT uses for your model
#model = "-subaru-impreza-wrx-sti-"
models = ["-mitsubishi-evolution-ix-", "-mitsubishi-lancer-evolution-", "-mitsubishi-evolution-viii-", "-mitsubishi-evolution-rs-"] 
...
one_offs = ["2005-mitsubishi-evolution-viii-mr", "2004-mitsubishi-lancer-evolution-8-rs", "2006-mitsubishi-evo-9-mr-se"]
# Capturing the one-off URLs
# Not the most elegant, but ensures we capture all the data points
for single in one_offs:    
    car = []
    car_price_str = ""
    sold = ""
    sold_bool = False
